...
#
# example usage: 
# $GOPATH/src/github.com/ThePolarNight/rclone/cmd/info/test.sh --list | \
#   parallel -P20 $GOPATH/src/github.com/ThePolarNight/rclone/cmd/info/test.sh

export PATH=$GOPATH/src/github.com/ThePolarNight/rclone:$PATH
