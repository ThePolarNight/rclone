...
page](https://github.com/ThePolarNight/rclone).

Now in your terminal

    git clone https://github.com/ThePolarNight/rclone.git
    cd rclone
...
rclone currently uses [GitHub Actions](https://github.com/ThePolarNight/rclone/actions) to build and test the project, which should be automatically available for your fork too from the `Actions` tab in your repository.
...
project root:
    ...
    go install github.com/ThePolarNight/rclone/fstest/test_all
...
[Go reference](https://godoc.org/github.com/ThePolarNight/rclone/lib/plugin)
